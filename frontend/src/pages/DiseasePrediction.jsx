          ...
          <div className="lg:col-span-1">
             <div className="bg-white rounded-2xl border border-gray-200 p-6 shadow-xl ring-1 ring-black/5 sticky top-24">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <a href="/recommendations/disease/history" className="text-sm font-medium text-red-600 hover:text-red-700 hover:underline">
                    View All
                  </a>
                </div>
                ...
                {history.length > 5 && (
                  <div className="mt-6 text-center">
                    <a href="/recommendations/disease/history" className="text-sm text-gray-500 hover:text-gray-900 font-medium">
